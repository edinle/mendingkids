...
const MISSIONS = [
  {
    ...
    status: 'PENDING',
    date: 'In 2 days',
    action: 'Add 7 items and submit 3 forms',
    location: 'Uganda',
  ...
  },
  {
    ...
    name: 'Mission Name',
    category: 'Infections',
    categoryColor: '#d63c8a',
    status: 'ONGOING',
    date: 'Now',
    action: 'Add 15 items and 3+ actions required',
    location: 'Guatemala',
    coordinator: 'Dr. Mark Patel',
    volunteers: 8,
    items: 93,
  },
  {
    ...
    name: 'Mission Name',
    category: 'ENT',
    categoryColor: '#1a7f37',
    status: 'ONGOING',
    date: 'Now',
    action: 'Finalize Mission Completion',
    location: 'Peru',
    coordinator: 'Dr. Emily Torres',
    volunteers: 6,
    items: 35,
  },
  {
    ...
    status: 'COMPLETED',
    date: 'Last week',
    action: 'Approve 4 forms',
    location: 'Honduras',
    coordinator: 'Dr. Alex Kim',
    volunteers: 15,
    items: 120,
  },
];
...
const EXPIRATION_ALERTS = [
  { id: 1, text: '50 Painkillers expire in three weeks', date: '02/10/26', item: 'Painkillers', qty: 50, location: 'Cabinet 3B', severity: 'warning' },
  { id: 2, text: '50 Painkillers expire in three weeks', date: '02/11/26', item: 'Painkillers', qty: 50, location: 'Cabinet 3C', severity: 'warning' },
  { id: 3, text: '50 Painkillers expire in three months', date: '05/10/26', item: 'Painkillers', qty: 50, location: 'Storage A', severity: 'caution' },
  { id: 4, text: '50 Painkillers expire in three months', date: '05/12/26', item: 'Painkillers', qty: 50, location: 'Storage A', severity: 'caution' },
  { id: 5, text: '50 Painkillers expire in three months', date: '05/15/26', item: 'Painkillers', qty: 50, location: 'Storage B', severity: 'caution' },
];

const RECENT_ACTIVITY = [
  { id: 1, text: 'added 10 gloves', time: '5 hours ago', initials: 'JD' },
  { id: 2, text: 'assigned 20 syringes to...', time: '6 hours ago', initials: 'SM' },
  { id: 3, text: 'donated 30 masks', time: '12 hours ago', initials: 'KL' },
  { id: 4, text: 'added 10 gloves', time: '1 day ago', initials: 'JD' },
  { id: 5, text: 'assigned 20 syringes to...', time: '2 days ago', initials: 'SM' },
  { id: 6, text: 'donated 30 masks', time: '1 week ago', initials: 'KL' },
  { id: 7, text: 'donated 30 masks', time: '1 week ago', initials: 'AL' },
];

const ITEM_STATUS_UPDATES = [
  { id: 1, name: 'Syringes',    qty: 12, status: 'donated',  statusColor: '#5e35b1' },
  { id: 2, name: 'Masks',       qty: 17, status: 'in use',   statusColor: '#1565c0' },
  { id: 3, name: 'Painkillers', qty: 20, status: 'expired',  statusColor: '#c62828' },
  { id: 4, name: 'Masks',       qty: 12, status: 'donated',  statusColor: '#5e35b1' },
  { id: 5, name: 'Item',        qty: 17, status: 'in use',   statusColor: '#1565c0' },
  { id: 6, name: 'Item',        qty: 20, status: 'expired',  statusColor: '#c62828' },
  { id: 7, name: 'Item',        qty: 25, status: 'expired',  statusColor: '#c62828' },
];
